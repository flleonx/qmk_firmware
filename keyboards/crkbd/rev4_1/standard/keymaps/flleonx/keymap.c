...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_NO,    KC_RALT,    KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
    ...
    [_LOWER] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_TRNS,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_NO,    KC_RALT,    KC_MINS,  KC_EQL,   KC_GRV,   KC_LBRC,  KC_RBRC,    KC_PIPE,
    ...
    [_RAISE] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_TRNS,  KC_MPRV,  KC_MNXT,  KC_VOLD,  KC_VOLU,  KC_MPLY,  KC_NO,    KC_TRNS,    KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,  KC_TRNS,
